...
<table >
  ...
  <tr >
     ...
     <td style="text-align:center"><a href="https://im.sdk.qcloud.com/download/plus/8.9.7540/ImSDK_Plus_8.9.7540.framework.zip">ImSDK_Plus.framework</a></td>
  </tr>
    
  <tr >
     <td style="text-align:center">XCFramework 版本</td>
     <td style="text-align:center">支持 Objective-C API 和 Mac catalyst</td>
     <td style="text-align:center"><a href="https://im.sdk.qcloud.com/download/plus/8.9.7540/ImSDK_Plus_8.9.7540.xcframework.zip">ImSDK_Plus.xcframework</a></td>
  </tr>

  <tr >
     <td style="text-align:center">Apple Vision Pro 版本</td>
     <td style="text-align:center">支持 visionOS 并提供 Swift API</td>
     <td style="text-align:center"><a href="https://im.sdk.qcloud.com/download/plus/8.9.7540/ImSDKForVision_Plus_8.9.7540.xcframework.zip">ImSDKForVision_Plus.xcframework</a></td>
  </tr>
</table>
...
<table >
  ...
  <tr >
     ...
     <td style="text-align:center"><a href="https://im.sdk.qcloud.com/download/plus/8.9.7540/TIMQuicPlugin_8.9.7540.framework.zip">TIMQuicPlugin.framework</a></td>
  </tr>
</table>
...
此外，我们还提供了 C 接口和 C++ 接口的 SDK，您可以从这里下载：[下载 C API 版本](https://im.sdk.qcloud.com/download/plus/8.9.7540/cross_platform/ImSDK_iOS_C_8.9.7540.framework.zip)、[下载 C++ API 版本](https://im.sdk.qcloud.com/download/plus/8.9.7540/cross_platform/ImSDK_iOS_CPP_8.9.7540.framework.zip)。
