...
> ⚠️ This directory is no longer maintained. Please use the dedicated repos below.
...
| Type | GitHub | Package | Integration Guide |
|---|---|---|---|
| **Flutter UIKit** (with UI) | [TUIKit_Flutter](https://github.com/Tencent-RTC/TUIKit_Flutter) | [pub: tuikit_atomic_x](https://pub.dev/packages/tuikit_atomic_x) | [UIKit for Flutter](https://trtc.io/document/58585) |
| **Flutter Core SDK** (no UI) | — | [pub: tencent_cloud_chat_sdk](https://pub.dev/packages/tencent_cloud_chat_sdk) | [SDK Integration (Flutter)](https://trtc.io/document/46264) |
